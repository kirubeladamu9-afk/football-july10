const translations = {
  am: {
    ...
    insights: {
      ...
      box1Des: <>መንግስታት እና የፖለቲካ መሪዎች እግር ኳስን ለስላሳ ስልጣን (Soft Power) እና ለዲፕሎማሲያዊ ተፅእኖ እንዴት እንደሚጠቀሙበት እንመረምራለን።</>,
  ...
  en: {
    ...
    // Feature/Insights
    insights: {
      title: <>Beyond the Pitch: The Nexus of Football <br /> Law, Politics and Society</>, 
